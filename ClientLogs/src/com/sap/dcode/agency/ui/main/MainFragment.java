...
import com.sap.dcode.agency.ui.logs.LogActivity;
import com.sap.dcode.agency.ui.offline.OfflineAgencyListActivity;
import com.sap.dcode.agency.ui.offline.OfflineErrorListActivity;
import com.sap.dcode.agency.ui.online.AgencyListActivity;
...
public class MainFragment extends Fragment implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.offline_button:
		    intent.setClass(getActivity(), OfflineAgencyListActivity.class);
		    startActivity(intent);
			break;

		case R.id.errorarchive_button:
		    intent.setClass(getActivity(), OfflineErrorListActivity.class);
		    startActivity(intent);
			break;
	...
	private void initializeViews() throws LogonCoreException{
		...
		Button errorArchiveBtn = (Button) myView.findViewById(R.id.errorarchive_button);
		errorArchiveBtn.setOnClickListener(this);
		
		Button clientLogBtn = (Button) myView.findViewById(R.id.logs_button);
		clientLogBtn.setOnClickListener(this);
