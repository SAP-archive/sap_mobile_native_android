...
public class AgencyRequestListener implements ODataRequestListener {
    ...
    protected void notifySuccessToListener(String key) {
        ...
        AgencyLogManager.writeLogDebug("AgencyRequestListener::notifySuccessToListener: "+key);
    ...
    protected void notifyErrorToListener(Exception exception) {
        ...
        msg.obj = exception;
        uiHandler.sendMessage(msg);
        AgencyLogManager.writeLogError("AgencyRequestListener::notifyErrorToListener", exception);
