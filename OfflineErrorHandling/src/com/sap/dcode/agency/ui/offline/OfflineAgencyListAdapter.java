...
public class OfflineAgencyListAdapter extends BaseAdapter {
    final private LayoutInflater inflater;
    final private OfflineAgencyListFragment fragment;
    final private List<Agency> agencies;
    final private ListView myList;

    public OfflineAgencyListAdapter(OfflineAgencyListFragment fragment, ListView myList, LayoutInflater inflater, List<Agency> agencies) {
